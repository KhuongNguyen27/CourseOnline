...
<header class="page-title-bar">
    ...
    <h1 class="page-title">Cập nhập học viên</h1>
</header>
<div class="page-section">
    <form method="post" action="{{ route('students.update',$item->id) }}" enctype="multipart/form-data">
        @csrf
        @method('PUT')
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            <label for="tf1">Tên người dùng<abbr name="Trường bắt buộc">*</abbr></label> <input
                                name="name" type="text" class="form-control" id="" value='{{ $item->name }}'>
